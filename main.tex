...
\caption{GRAPHIC NEEDS TO CHANGE.
...
This setting displays preference reversal: $g_a<g_b$ for $t_0$ sufficienly large and negative (long horizon); and $g_a>g_b$ for $t_0$ sufficiently close to $t_a$ (short horizon). No closed-form expression for the reversal time, $t_0^\text{PR}$, is available.
